...
private ["_blacklist","_center_z","_slack","_wp_array","_newangle","_grp","_pos","_max_dist","_debug","_mode","_formation","_center_x","_center_y","_wp_count","_angle","_new_angle","_angle_offset","_wp1","_wp2"];
_grp = _this select 0;
_pos = _this select 1;
